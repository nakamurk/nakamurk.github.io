...
const CACHE_KEY = "sticky_movie_beta_v1_5_cache";
...
function playByValues(seek, sleep) {
  ...
  state.player.seekTo(Number(seek) || 0);
  state.sleepTime = Number(sleep) || 0;
...
function syncSection1ToggleState() {
  if (!section1HeaderToggle) return;
  const section1 = document.getElementById("section1");
  const expanded = !!(section1 && section1.open);
  section1HeaderToggle.setAttribute("aria-expanded", expanded ? "true" : "false");
}

function toggleSection1FromHeader() {
  const section1 = document.getElementById("section1");
  if (!section1) return;
  section1.open = !section1.open;
  syncSection1ToggleState();
}

function showSection1ByHover() {
  const section1 = document.getElementById("section1");
  if (!section1) return;
...
function scheduleHideSection1ByHover() {
  const section1 = document.getElementById("section1");
  if (!section1) return;
...
if (section1HeaderToggle) section1HeaderToggle.addEventListener("click", toggleSection1FromHeader);
if (section1HeaderToggle) {
  section1HeaderToggle.addEventListener("mouseenter", showSection1ByHover);
  section1HeaderToggle.addEventListener("mouseleave", scheduleHideSection1ByHover);
}
...
const section1Details = document.getElementById("section1");
if (section1Details) section1Details.addEventListener("toggle", syncSection1ToggleState);
if (section1Details) {
  section1Details.addEventListener("mouseenter", showSection1ByHover);
  section1Details.addEventListener("mouseleave", scheduleHideSection1ByHover);
}
...
window.addEventListener("resize", updateReportTopOffset);
